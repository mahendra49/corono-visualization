...
class Circle {
  ...
  update() {
    if (this.color == INFECTED_COLOR) {
      this.ttl =
        this.ttl -
        (_utils__WEBPACK_IMPORTED_MODULE_0__["default"].getRandomInt(2, REDUCE_HEALTH_BY_FACTOR_MAX_LIMIT) * 100) /
          this.ttl;
    ...
    if (this.color == INFECTED_COLOR) {
      this.ttl =
        this.ttl +
        (_utils__WEBPACK_IMPORTED_MODULE_0__["default"].getRandomInt(1, INCR_HEALTH_BY_FACTOR_MAX_LIMIT) * 100) /
          this.ttl;
    }
...
function collide(circle) {
  for (let i of circles) {
    ...
    if (distance < MAX_DISTANCE && circle.color === INFECTED_COLOR) {
      ...
      i.ttl = _utils__WEBPACK_IMPORTED_MODULE_0__["default"].getRandomInt(350, 500);
    }
  }
}
...
function fill_infected(count) {
  for (let i = 0; i < count; i++) {
    ...
    circles[i].ttl = _utils__WEBPACK_IMPORTED_MODULE_0__["default"].getRandomInt(350, 400);
  }
}
...
function randomlyInfect(count) {
  for (let i = 0; i < count; i++) {
    const randome_number = _utils__WEBPACK_IMPORTED_MODULE_0__["default"].getRandomInt(0, circles.length - 1);
    circles[i].color = INFECTED_COLOR;
    circles[i].ttl = _utils__WEBPACK_IMPORTED_MODULE_0__["default"].getRandomInt(350, 450);
  }
}
